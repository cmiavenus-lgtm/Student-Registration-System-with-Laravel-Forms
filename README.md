...
|------------|-------------|
| Student Registration.jpg | Registration form with all fields |
| Validation Error.jpg | Error messages displayed |
| Flash success message.jpg | Success notification |
| student profile.jpg.png | Student profile page |
