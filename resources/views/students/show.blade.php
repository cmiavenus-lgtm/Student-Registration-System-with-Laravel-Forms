...
<div class="max-w-4xl mx-auto">
    <div class="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <a href="{{ route('students.create') }}" class="inline-flex items-center gap-2 text-sm text-indigo-600 hover:text-indigo-700 font-semibold">+ Register Another Student</a>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
        ...
        <div class="h-32 bg-gradient-to-r from-indigo-600 to-blue-600 relative">
            <div class="absolute -bottom-12 left-6 sm:left-8 flex items-end gap-4">
                ...
                <div class="pb-2 hidden sm:block">
                    ...
                    <p class="text-indigo-100 text-sm font-mono">{{ $student->student_id }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="pt-16 sm:pt-6 px-6 sm:pl-40 pb-6 sm:pb-6 border-b border-slate-100">
            <div class="sm:hidden">
                ...
                <p class="text-sm font-mono text-indigo-600 font-semibold">{{ $student->student_id }}</p>
            </div>
            ...
            <div class="space-y-5">
                <div>
                    <h3 class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-3 flex items-center gap-2">
                        <span class="w-6 h-6 bg-indigo-50 rounded-lg flex items-center justify-center"><svg class="w-3 h-3 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg></span>
        ...
        <div class="px-6 sm:px-8 py-4 bg-slate-50 border-t border-slate-200 flex flex-col sm:flex-row gap-3 sm:justify-between">
            ...
            <a href="{{ route('students.create') }}" class="inline-flex justify-center items-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-600 text-white font-semibold text-sm hover:bg-indigo-700 shadow transition">Register Another Student</a>
        </div>
    </div>
</div>
@endsection
